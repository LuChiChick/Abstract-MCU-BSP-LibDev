#ifndef __CUS__SOFT_IIC_WIRE__
#define __CUS__SOFT_IIC_WIRE__
...
{
    //软模拟IIC信号实现
    class Soft_IIC_Wire : public abs_IIC_Wire
    {
    protected:
    ...
    public:
         ...
         */
        Soft_IIC_Wire(abs_GPIO_Wire &SCL_Wire, abs_GPIO_Wire &SDA_Wire);
         ...
         */
        virtual Soft_IIC_Wire &construct(abs_GPIO_Wire &SCL_Wire, abs_GPIO_Wire &SDA_Wire);
         ...
         */
        virtual IIC_Wire_Error focus_on(uint8_t Aim_addr);

        /**
         *   设定速度阈值
         *   @param speed_threshold 速度阈值
         */
        virtual void speedLimit(int speed_threshold);
         ...
         *   @return IIC_Wire_Error异常抛出
         */
        virtual IIC_Wire_Error write(uint8_t data);
         ...
         *   @return IIC_Wire_Error异常抛出
         */
        virtual IIC_Wire_Error request(uint8_t count);
